...
export default class ProjectAbstraction {
    ...
    private corePackages;
    private folders;
    constructor(name: string, about: string, specifications: ProjectSpecifications, packages: PackageAbstraction[]);
    createProject(force?: boolean): void;
