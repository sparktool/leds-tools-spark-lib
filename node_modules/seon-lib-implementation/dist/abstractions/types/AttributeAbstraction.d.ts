...
export default class AttributeAbstraction {
    ...
    constructor(name: string, _type: TypeAbstraction, _static?: boolean, visibility?: VisibilityOptions, defaultValue?: string);
    getName(): string;
    getType(): TypeAbstraction;
    asArgument(): ArggumentAbstraction;
