...
export const frontendFiles: { [key: string]:   string  } = {
    ".browserslistrc": expandToString`
> 1%
last 2 versions
not dead
not ie 11`,

    ".editorconfig": expandToString`
...
*.sw?`,
    ...
    "components.d.ts": expandToString`
/* eslint-disable */
// @ts-nocheck
...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    "env.d.ts": expandToString`/// <reference types="vite/client" />`,

    "index.html": expandToString`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
    ...
    "package.json": expandToString`
{
  ...
  "devDependencies": {
    ...
    "tsconfig.app.json": expandToString`
{
    ...
    "tsconfig.json": expandToString`
{
  ...
  "references": [
    ...
    "tsconfig.node.json": expandToString`
{
  ...
  "compilerOptions": {
    ...
    "vite.config.mts": expandToString`
// Plugins
